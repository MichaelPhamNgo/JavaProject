...
public class Title extends JPanel implements MouseListener, MouseMotionListener{
	...
	public Title(Window window){
		try {
			title = ImageIO.read(Board.class.getResource("/images/title.png"));
			instructions = ImageIO.read(Board.class.getResource("/images/arrow.png"));
			play = ImageIO.read(Board.class.getResource("/images/play.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
