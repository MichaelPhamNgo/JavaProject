...
public class KhoaHoc implements Serializable{
    ...
    public String toString() {
        return "KhoaHoc{" + "ma_hoc_vien=" + ma_hoc_vien + ", ten_khoa_hoc=" + ten_khoa_hoc + ", mo_ta=" + mo_ta + ", ngay_bat_dau=" + ngay_bat_dau + ", ngay_ket_thuc=" + ngay_ket_thuc + ", tinh_trang=" + tinh_trang + '}';
    }
